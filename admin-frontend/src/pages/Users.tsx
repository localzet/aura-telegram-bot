    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            ...
            notifications.show({
                color: 'red',
                title: 'Ошибка',
                message: error.response?.data?.message || 'Не удалось удалить пользователя',
            });
        }
    };
                ...
                {editingUser && (
                    <Stack>
                        ...
                        <NumberInput
                            ...
                            onChange={(value) =>
                                setEditingUser({ ...editingUser, grantedArgentum: Number(value) })
                            }
                        />
                        <NumberInput
                            label="Granted Aurum"
                        ...
                        <NumberInput
                            ...
                            onChange={(value) =>
                                setEditingUser({ ...editingUser, grantedPlatinum: Number(value) })
                            }
                        />
