...
> = {
  ru: {
    ...
    select_level:
      "Выберите уровень, который хотите назначить пользователю {name}:",
  ...
  en: {
    ...
    error_loading_tariffs:
      "⚠️ An error occurred while loading tariffs. Please try again later.",
    ...
    payment_error:
      "⚠️ Payment completed, but an error occurred during activation. We will resolve this issue shortly.",
    ...
    referral_note:
      "<i>Important! Discount is only given for friends invited in the current month (counter resets every month)</i>",
    ...
    level_granted:
      "✅ User {name} has been successfully assigned level {level}.",
